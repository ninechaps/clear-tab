    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 flex gap-3">
        ...
        <button
          ...
          className="p-3 bg-white/8 hover:bg-white/15 backdrop-blur-xl border border-white/10 hover:border-white/20 rounded-xl text-white/50 hover:text-white transition-all duration-300 group cursor-pointer hover:scale-105 hover:shadow-lg animate-fade-in"
